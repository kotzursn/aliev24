        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    -->
                    <form method="post" action="view-student.php"
                ...
                <div class="container-fluid">
                    ...
                    if (isset($_POST['keySearch'])){
                        ...
                        $query = "SELECT * FROM students where name like '%$keySearch%' or znum like '%$keySearch%' or dateBirth like '%$keySearch%' or course like '%$keySearch%' or groups like '%$keySearch%'"; //, znum, dateBirth, course, groups
                    }
                    ...
                    echo "<tr><th scope='col'>" . "ID". "</th><th scope='col'>" . "Номер зачетки" . "</th><th scope='col'>" . "ФИО студента" . "</th><th scope='col'>" . "Дата рождения" . "</th><th scope='col'>" . "Группа" ."</th></tr>";
                    while($row = mysqli_fetch_array($r)){   //Creates a loop to loop through results
                    echo "<tr><td>" . htmlspecialchars($row['id']) . "</td><td>";
                    
                    $zn = htmlspecialchars($row['znum']);
                    echo '<a href="edit-student.php?zn='.$zn.'">'. $zn .'</a>';
                    
                    echo "</td><td>" . htmlspecialchars($row['name']) . "</td><td>" . htmlspecialchars($row['dateBirth']) . "</td><td>" . htmlspecialchars($row['groups']) ."</td></tr>";  //$row['index'] the index here is a field name
                    }
